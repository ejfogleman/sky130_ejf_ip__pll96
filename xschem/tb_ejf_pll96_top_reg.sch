...
*** ejf_pll96 regression
*** run with:
*** ngspice -b -r top_reg.raw -o top_reg.out tb_ejf_pll96_top_reg.spice
...
.control
   ...
   save xpll.xchp.cp_repl xpll.xchp.mp1g xpll.xchp.mp1cg xpll.xchp.mn1g xpll.xchp.mn1cg xpll.xchp.amp_inp
   save xpll.xchp.mn1d xpll.xchp.mp1d xpll.xchp.mp1cd xpll.xchp.mn1cd
   save xpll.xlpf.mpc2g xpll.xlpf.bp
   tran 1n 20u
   write tb_ejf_pll96_top_reg.raw
   ...
   meas tran T_CLK_OUT trig v(clk_out) val=0.9 rise=1 td=19u targ v(clk_out) val=0.9 rise=2 td=19u
   print 1/T_CLK_OUT
.endc
"}
...
C {isource.sym} 640 -320 0 0 {name=I1 value=\{IB\}}
C {lab_wire.sym} 640 -360 0 1 {name=p3 sig_type=std_logic lab=ibnp_1u}
