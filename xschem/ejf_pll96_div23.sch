...
C {opin.sym} 950 -320 0 0 {name=p3 lab=q2}
...
C {sky130_stdcells/dfstp_2.sym} 240 -340 2 1 {name=x1 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_ls__}
C {ipin.sym} 50 -360 0 0 {name=p8 lab=en}
C {sky130_stdcells/dfsbp_2.sym} 750 -340 2 1 {name=x2 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_ls__}
